...
namespace util
{
    ...
    {
        const std::string headerLibraryResourceID = SDK().GetResourceID(p_HeaderLibraryruntimeResourceID);
    ...
    {
        const ZRuntimeResourceID headerLibraryRuntimeResourceID = SDK().GetRuntimeResourceID(p_HeaderLibraryResourceID.c_str());
    ...
    {
        ZRuntimeResourceID resourceRuntimeResourceID = SDK().GetRuntimeResourceID(p_ResourceID.c_str());
