...
Extract the contents of the `AbsolutionSDK-Release.zip` archive to your Hitman Absolution installation directory.

For example:

- **Steam:** `<drive>:\Program Files (x86)\Steam\steamapps\common\Hitman Absolution`
- **GOG:** `<drive>:\GOG Games\Hitman Absolution\retail`
- **GOG Galaxy:** `<drive>:\Program Files (x86)\GOG Galaxy\Games\Hitman Absolution\retail`

> **Note:** For the GOG and GOG Galaxy versions, make sure to extract the SDK into the `retail` directory, not the root Hitman Absolution installation directory.
